 ...
 * @version 1.0
 * @date 2022-03-29
 * @brief Device specific configuration file for MCXA132 (header file)
 *
...
#ifndef _SYSTEM_MCXA132_H_
#define _SYSTEM_MCXA132_H_                       /**< Symbol preventing repeated inclusion */
