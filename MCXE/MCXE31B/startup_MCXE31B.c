...
//*****************************************************************************
WEAK void INT0_IRQHandler(void);
WEAK void INT1_IRQHandler(void);
WEAK void INT2_IRQHandler(void);
WEAK void INT3_IRQHandler(void);
...
WEAK void SWT1_IRQHandler(void);
...
WEAK void ENET_0_IRQHandler(void);
WEAK void ENET_1_IRQHandler(void);
WEAK void ENET_2_IRQHandler(void);
WEAK void ENET_3_IRQHandler(void);
...
WEAK void HSE_B_0_IRQHandler(void);
WEAK void HSE_B_1_IRQHandler(void);
WEAK void HSE_B_2_IRQHandler(void);
WEAK void HSE_B_3_IRQHandler(void);
WEAK void HSE_B_4_IRQHandler(void);
WEAK void HSE_B_5_IRQHandler(void);
WEAK void Reserved216_IRQHandler(void);
WEAK void Reserved217_IRQHandler(void);
WEAK void MU_A_0_IRQHandler(void);
WEAK void MU_A_1_IRQHandler(void);
WEAK void MU_A_2_IRQHandler(void);
WEAK void MU_B_0_IRQHandler(void);
WEAK void MU_B_1_IRQHandler(void);
WEAK void MU_B_2_IRQHandler(void);
...
//*****************************************************************************
void INT0_DriverIRQHandler(void) ALIAS(DefaultISR);
void INT1_DriverIRQHandler(void) ALIAS(DefaultISR);
void INT2_DriverIRQHandler(void) ALIAS(DefaultISR);
void INT3_DriverIRQHandler(void) ALIAS(DefaultISR);
...
void ENET_0_DriverIRQHandler(void) ALIAS(DefaultISR);
void ENET_1_DriverIRQHandler(void) ALIAS(DefaultISR);
void ENET_2_DriverIRQHandler(void) ALIAS(DefaultISR);
void ENET_3_DriverIRQHandler(void) ALIAS(DefaultISR);
...
void Reserved208_DriverIRQHandler(void) ALIAS(DefaultISR);
void Reserved209_DriverIRQHandler(void) ALIAS(DefaultISR);
void HSE_B_0_DriverIRQHandler(void) ALIAS(DefaultISR);
void HSE_B_1_DriverIRQHandler(void) ALIAS(DefaultISR);
void HSE_B_2_DriverIRQHandler(void) ALIAS(DefaultISR);
void HSE_B_3_DriverIRQHandler(void) ALIAS(DefaultISR);
void HSE_B_4_DriverIRQHandler(void) ALIAS(DefaultISR);
void HSE_B_5_DriverIRQHandler(void) ALIAS(DefaultISR);
void Reserved216_DriverIRQHandler(void) ALIAS(DefaultISR);
void Reserved217_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU_A_0_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU_A_1_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU_A_2_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU_B_0_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU_B_1_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU_B_2_DriverIRQHandler(void) ALIAS(DefaultISR);
...
#error Unsupported toolchain!
    ...
    INT3_IRQHandler,         // 19 : CPU to CPU int3
    ...
    MCM_IRQHandler,          // 54 : Multi bit ECC error
    ...
    SWT1_IRQHandler,         // 59 : Platform watchdog initial time-out
    ...
    WKPU_IRQHandler,         // 99 : Interrupts from pad group 0,1,2,3, Interrupts from pad group 0_64, Interrupts from pad group 1_64, Interrupts from pad group 2_64, Interrupts from pad group 3_64
    CMU0_IRQHandler,         // 100: CMU0 interrupt
    CMU1_IRQHandler,         // 101: CMU1 interrupt
    CMU2_IRQHandler,         // 102: CMU2 interrupt
    BCTU_IRQHandler,         // 103: An interrupt is requested when a conversion is issued to the ADC, An interrupt is requested when new data is available from ADC0 conversion, An interrupt is requested when new data is available from ADC1 conversion, An interrupt is requested when new data is available from ADC2 conversion, An interrupt is requested when the last command of a list is issued to the ADC,An Interrupt output for FIFO1,An Interrupt output for FIFO2
    ...
    LCU0_IRQHandler,         // 108: Interrupt 0, Interrupt 1 Interrupt 2
    LCU1_IRQHandler,         // 109: Interrupt 0, Interrupt 1 Interrupt 2
    ...
    RTC_IRQHandler,          // 118: RTCF or ROVRF interrupt to be serviced by the system controller, APIF interrupt to be serviced by the system controller
    Reserved119_IRQHandler,  // 119: Reserved interrupt
    Reserved120_IRQHandler,  // 120: Reserved interrupt
    ENET_0_IRQHandler,       // 121: Common interrupt
    ENET_1_IRQHandler,       // 122: Tx interrupt 0, Tx interrupt 1
    ENET_2_IRQHandler,       // 123: Rx interrupt 0, Rx interrupt 1
    ENET_3_IRQHandler,       // 124: Safety interrupt correctable, Safety interrupt un-correctable
    ...
    QSPI_IRQHandler,         // 189: TX Buffer Fill interrupt, Transfer Complete / Transaction Finished, RX Buffer Drain interrupt, Buffer Overflow / Underrun interrupt, Serial Flash Communication Error interrupt, All interrupts ORed output
    ...
    HSE_B_0_IRQHandler,      // 210: ORed TX interrupt to MU-0
    HSE_B_1_IRQHandler,      // 211: ORed RX interrupt to MU-0
    HSE_B_2_IRQHandler,      // 212: ORed general purpose interrupt request to MU-0
    HSE_B_3_IRQHandler,      // 213: ORed TX interrupt to MU-1
    HSE_B_4_IRQHandler,      // 214: ORed RX interrupt to MU-1
    HSE_B_5_IRQHandler,      // 215: ORed general purpose interrupt request to MU-1
    Reserved216_IRQHandler,  // 216: Reserved interrupt
    Reserved217_IRQHandler,  // 217: Reserved interrupt
    MU_A_0_IRQHandler,       // 218: ORed TX interrupt to MUA
    MU_A_1_IRQHandler,       // 219: ORed RX interrupt to MUA
    MU_A_2_IRQHandler,       // 220: ORed general purpose interrupt request to MUA
    MU_B_0_IRQHandler,       // 221: ORed TX interrupt to MUB
    MU_B_1_IRQHandler,       // 222: ORed RX interrupt to MUB
    MU_B_2_IRQHandler,       // 223: ORed general purpose interrupt request to MUB
}; /* End of vector */
...
void Reset_Handler(void) {
    ...
    __asm volatile ("LDR     R0, =0x20408000     \n"
                    ...
                    ".ram_init_start:            \n"
                    "LDR     R1, =0x2044FFFF     \n"
                    "LDR     R2, =.ram_init_sram \n"
                    "CMP     R1, R2              \n"
                    "BCC.N   .ram_init_sram_done \n"
                    ".ram_init_sram:             \n"
                    "LDR     R2, =0              \n"
                    "LDR     R3, =0              \n"
                    "LDR     R4, =0              \n"
...
//*****************************************************************************
WEAK void INT0_IRQHandler(void)
{   INT0_DriverIRQHandler();
}

WEAK void INT1_IRQHandler(void)
{   INT1_DriverIRQHandler();
}

WEAK void INT2_IRQHandler(void)
{   INT2_DriverIRQHandler();
}

WEAK void INT3_IRQHandler(void)
{   INT3_DriverIRQHandler();
}
...
WEAK void ENET_0_IRQHandler(void)
{   ENET_0_DriverIRQHandler();
}

WEAK void ENET_1_IRQHandler(void)
{   ENET_1_DriverIRQHandler();
}

WEAK void ENET_2_IRQHandler(void)
{   ENET_2_DriverIRQHandler();
}

WEAK void ENET_3_IRQHandler(void)
{   ENET_3_DriverIRQHandler();
}
...
WEAK void HSE_B_0_IRQHandler(void)
{   HSE_B_0_DriverIRQHandler();
}

WEAK void HSE_B_1_IRQHandler(void)
{   HSE_B_1_DriverIRQHandler();
}

WEAK void HSE_B_2_IRQHandler(void)
{   HSE_B_2_DriverIRQHandler();
}

WEAK void HSE_B_3_IRQHandler(void)
{   HSE_B_3_DriverIRQHandler();
}

WEAK void HSE_B_4_IRQHandler(void)
{   HSE_B_4_DriverIRQHandler();
}

WEAK void HSE_B_5_IRQHandler(void)
{   HSE_B_5_DriverIRQHandler();
}
...
WEAK void MU_A_0_IRQHandler(void)
{   MU_A_0_DriverIRQHandler();
}

WEAK void MU_A_1_IRQHandler(void)
{   MU_A_1_DriverIRQHandler();
}

WEAK void MU_A_2_IRQHandler(void)
{   MU_A_2_DriverIRQHandler();
}

WEAK void MU_B_0_IRQHandler(void)
{   MU_B_0_DriverIRQHandler();
}

WEAK void MU_B_1_IRQHandler(void)
{   MU_B_1_DriverIRQHandler();
}

WEAK void MU_B_2_IRQHandler(void)
{   MU_B_2_DriverIRQHandler();
}
