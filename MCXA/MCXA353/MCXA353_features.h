...
#ifndef _MCXA353_FEATURES_H_
#define _MCXA353_FEATURES_H_

/* SOC module features */

#if defined(CPU_MCXA353VFM)
...
#elif defined(CPU_MCXA353VLF) || defined(CPU_MCXA353VLH) || defined(CPU_MCXA353VLL)
    /* @brief AOI availability on the SoC. */
    #define FSL_FEATURE_SOC_AOI_COUNT (2)
    /* @brief CDOG availability on the SoC. */
    #define FSL_FEATURE_SOC_CDOG_COUNT (1)
