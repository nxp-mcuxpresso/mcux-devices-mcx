...
#if !defined(MCXA144_COMMON_H_)
#define MCXA144_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_MCXA144.h"            /* Device specific configuration file */
