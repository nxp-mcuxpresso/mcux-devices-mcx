...
#if !defined(MCXC041_COMMON_H_)
#define MCXC041_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_MCXC041.h"            /* Device specific configuration file */

#ifndef MCXC041_SERIES
