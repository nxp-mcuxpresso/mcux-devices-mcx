 ...
 * @version 1.0
 * @date 2025-05-12
 * @brief Device specific configuration file for MCXE316 (header file)
 *
...
#ifndef _SYSTEM_MCXE316_H_
#define _SYSTEM_MCXE316_H_ /**< Symbol preventing repeated inclusion */
