 ...
 * @version 1.0
 * @date 2023-01-09
 * @brief Device specific configuration file for MCXL143 (implementation file)
 *
...
__attribute__ ((weak)) void SystemInit (void) {
  ...
  if ((*((volatile uint32_t *)(0x1000000)) == 0xFFFFFFFFU) ||
     ((*((volatile uint32_t *)(0x1000000)) == 0x59630000U) &&
     (*((volatile uint32_t *)(0x1000040)) == 0xFFFFFFFFU) &&
     (*((volatile uint32_t *)(0x1000044)) == 0xFFFFFFFFU) &&
     (*((volatile uint32_t *)(0x1000048)) == 0xFFFFFFFFU) &&
     (*((volatile uint32_t *)(0x100004C)) == 0xFFFFFFFFU) &&
     (*((volatile uint32_t *)(0x1000050)) == 0xFFFFFFFFU) &&
     (*((volatile uint32_t *)(0x1000054)) == 0xFFFFFFFFU) &&
     (*((volatile uint32_t *)(0x1000058)) == 0xFFFFFFFFU) &&
     (*((volatile uint32_t *)(0x100005C)) == 0xFFFFFFFFU)))
  {
