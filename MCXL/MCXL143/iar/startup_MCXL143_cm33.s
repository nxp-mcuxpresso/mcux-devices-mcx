...
__vector_table_0x1c
        ...
        DCD     Reserved43_IRQHandler                         ;xxx Interrupt 43
...
Reserved163_IRQHandler
        ...
        PUBWEAK Reserved164_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
Reserved164_IRQHandler
        LDR     R0, =Reserved164_DriverIRQHandler
        BX      R0
...
Reserved172_IRQHandler
        ...
        PUBWEAK Reserved173_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
Reserved173_IRQHandler
        LDR     R0, =Reserved173_DriverIRQHandler
        BX      R0
