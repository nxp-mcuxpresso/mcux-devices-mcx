 ...
 * @version 1.0
 * @date 2023-01-09
 * @brief Device specific configuration file for MCXL143 (header file)
 *
...
#ifndef _SYSTEM_MCXL143_H_
#define _SYSTEM_MCXL143_H_                       /**< Symbol preventing repeated inclusion */
