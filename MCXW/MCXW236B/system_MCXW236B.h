 ...
 * @version 1.0
 * @date 2022-03-08
 * @brief Device specific configuration file for MCXW236B (header file)
 *
...
#ifndef _SYSTEM_MCXW236B_H_
#define _SYSTEM_MCXW236B_H_                      /**< Symbol preventing repeated inclusion */
