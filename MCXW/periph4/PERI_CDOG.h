...
typedef struct {
  ...
  __O  uint32_t ASSERT16;                          /**< Write address for issuing the ASSERT16 command., offset: 0x4C */
} CDOG_Type;
...
/*! @name ASSERT16 - Write address for issuing the ASSERT16 command. */
/*! @{ */

#define CDOG_ASSERT16_ASSERT16_MASK              (0xFFFFU)
#define CDOG_ASSERT16_ASSERT16_SHIFT             (0U)
/*! ASSERT16 - Assert value. */
#define CDOG_ASSERT16_ASSERT16(x)                (((uint32_t)(((uint32_t)(x)) << CDOG_ASSERT16_ASSERT16_SHIFT)) & CDOG_ASSERT16_ASSERT16_MASK)
/*! @} */
