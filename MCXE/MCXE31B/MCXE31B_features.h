...
#ifndef _MCXE31B_FEATURES_H_
#define _MCXE31B_FEATURES_H_

/* SOC module features */

/* @brief ADC availability on the SoC. */
#define FSL_FEATURE_SOC_ADC_COUNT (3)
/* @brief AIPS availability on the SoC. */
#define FSL_FEATURE_SOC_AIPS_COUNT (3)
...
#define FSL_FEATURE_ADC_INSTANCE_SUPPORT_GROUP3n(x) \
    (((x) == ADC_0) ? (1) : \
    (((x) == ADC_1) ? (1) : \
    (((x) == ADC_2) ? (0) : (-1))))
...
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWF1_VDD_HV_B_VLT_DVDR_EN (1)
/* @brief Has bit DCMRWF1[VDD_1_5_VLT_DVDR_EN]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWF1_VDD_1_5_VLT_DVDR_EN (1)
/* @brief Has bit DCMRWF2[SIRC_TRIM_BYP_STDBY_EXT]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWF2_SIRC_TRIM_BYP_STDBY_EXT (1)
/* @brief Has bit DCMRWF2[PMC_TRIM_RGM_DCF__BYP_STDBY_EXT]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWF2_PMC_TRIM_RGM_DCF__BYP_STDBY_EXT (1)
/* @brief Has bit DCMRWD6[EMIOS2_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_EMIOS2_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[SWT1_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_SWT1_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[STM1_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_STM1_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[PIT2_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_PIT2_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[LPSPI4_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_LPSPI4_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[LPSPI5_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_LPSPI5_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[FLEXCAN3_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_FLEXCAN3_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[FLEXCAN4_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_FLEXCAN4_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[FLEXCAN5_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_FLEXCAN5_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[SAI0_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_SAI0_DBG_DIS_CM7_0 (1)
/* @brief Has bit DCMRWD6[SAI1_DBG_DIS_CM7_0]. */
#define FSL_FEATURE_DCM_GPR_HAS_DCMRWD6_SAI1_DBG_DIS_CM7_0 (1)
...
#define FSL_FEATURE_MC_CGM_HAS_MUX_2 (1)
/* @brief Has MUX_4 Registers */
#define FSL_FEATURE_MC_CGM_HAS_MUX_4 (1)
/* @brief Has MUX_7 Registers */
#define FSL_FEATURE_MC_CGM_HAS_MUX_7 (1)
/* @brief Has MUX_8 Registers */
#define FSL_FEATURE_MC_CGM_HAS_MUX_8 (1)
/* @brief Has MUX_9 Registers */
#define FSL_FEATURE_MC_CGM_HAS_MUX_9 (1)
