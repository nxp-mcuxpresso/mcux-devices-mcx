...
#define PUF_KEYLOCK_KEY4_MASK                    (0x300U)
#define PUF_KEYLOCK_KEY4_SHIFT                   (8U)
/*! KEY4 - "10:Write access to KEY4MASK, KEYENABLE.KEY4 and KEYRESET.KEY4 is allowed. 00, 01,
 *    11:Write access to KEY4MASK, KEYENABLE.KEY4 and KEYRESET.KEY4 is NOT allowed. Important Note : Once
 *    this field is written with a value different from '10', its value can no longer be modified
 *    until un Power On Reset occurs."
 */
#define PUF_KEYLOCK_KEY4(x)                      (((uint32_t)(((uint32_t)(x)) << PUF_KEYLOCK_KEY4_SHIFT)) & PUF_KEYLOCK_KEY4_MASK)
/*! @} */
...
#define PUF_KEYENABLE_KEY4_MASK                  (0x300U)
#define PUF_KEYENABLE_KEY4_SHIFT                 (8U)
/*! KEY4 - "10: Data coming out from PUF Index 0 interface are shifted in KEY4 register. 00, 01, 11
 *    : Data coming out from PUF Index 0 interface are NOT shifted in KEY3 register."
 */
#define PUF_KEYENABLE_KEY4(x)                    (((uint32_t)(((uint32_t)(x)) << PUF_KEYENABLE_KEY4_SHIFT)) & PUF_KEYENABLE_KEY4_MASK)
/*! @} */
...
#define PUF_KEYRESET_KEY4_MASK                   (0x300U)
#define PUF_KEYRESET_KEY4_SHIFT                  (8U)
/*! KEY4 - 10: Reset KEY4 shift register. Self clearing. Must be done before loading any new key. */
#define PUF_KEYRESET_KEY4(x)                     (((uint32_t)(((uint32_t)(x)) << PUF_KEYRESET_KEY4_SHIFT)) & PUF_KEYRESET_KEY4_MASK)
/*! @} */
...
#define PUF_SHIFT_STATUS_KEY4_MASK               (0xF0000U)
#define PUF_SHIFT_STATUS_KEY4_SHIFT              (16U)
/*! KEY4 - Index counter from key 4 shift register */
#define PUF_SHIFT_STATUS_KEY4(x)                 (((uint32_t)(((uint32_t)(x)) << PUF_SHIFT_STATUS_KEY4_SHIFT)) & PUF_SHIFT_STATUS_KEY4_MASK)
/*! @} */
