...
typedef struct {
  ...
  __IO uint32_t ISFR[GPIO_ISFR_COUNT];             /**< Interrupt Status Flag, array offset: 0x120, array step: 0x4, irregular array, not all indices are valid */
} GPIO_Type;
 ...
 *  0b0..Interrupt, or DMA request 0
 *  0b1..Interrupt, or DMA request 1
 */
