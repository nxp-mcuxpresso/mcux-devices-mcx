...
/* Select UART2. */
/* User needs to provide the implementation of UARTX_GetFreq/UARTX_InitPins/UARTX_DeinitPins for the enabled
 * UART instance. */
#define RTE_USART2        0
...
#define RTE_I2C1_DMA_TX_PERI_SEL    (uint8_t) kDmaRequestMux0I2C1
#define RTE_I2C1_DMA_TX_DMAMUX_BASE DMAMUX0
#define RTE_I2C1_DMA_TX_DMA_BASE    DMA0
#define RTE_I2C1_DMA_RX_CH          0
#define RTE_I2C1_DMA_RX_PERI_SEL    (uint8_t) kDmaRequestMux0I2C1
