 ...
 * @version 1.0
 * @date 2025-02-21
 * @brief Device specific configuration file for MCXE246 (header file)
 *
...
#ifndef _SYSTEM_MCXE246_H_
#define _SYSTEM_MCXE246_H_                       /**< Symbol preventing repeated inclusion */
