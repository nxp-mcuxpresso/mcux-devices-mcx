...
#define XRDC_MDA_COUNT                            6u
#define XRDC_PDAC_COUNT                           316u
#define XRDC_PDAC_PDAC_Wx_COUNT                   2u
#define XRDC_MRGD_MRGD_Wx_COUNT                   4u
#define XRDC_MRGD_COUNT                           36u
...
typedef struct {
  ...
  __I  uint8_t MDACFG[XRDC_MDACFG_COUNT];          /**< Master Domain Assignment Configuration, array offset: 0x100, array step: 0x1, valid indices: [0-3, 5] */
  ...
  __IO uint32_t DERR_W[XRDC_DERR_Wx_COUNT][XRDC_DERR_Wx_DERR_W_COUNT]; /**< Domain Error Word 0..Domain Error Word 3, array offset: 0x400, array step: index*0x10, index2*0x4, valid indices: [0-2, 16-18][0], [0-2, 16-18][1], [0-2, 16-18][3] */
  ...
  struct {                                         /* offset: 0x800, array step: 0x20 */
    __IO uint32_t MDA_W[XRDC_MDA_MDA_Wx_COUNT];      /**< Master Domain Assignment, array offset: 0x800, array step: index*0x20, index2*0x4, valid indices: [0-3, 5][0] */
         uint8_t RESERVED_0[28];
  } MDA[XRDC_MDA_COUNT];
       uint8_t RESERVED_7[1856];
  __IO uint32_t PDAC_W[XRDC_PDAC_COUNT][XRDC_PDAC_PDAC_Wx_COUNT]; /**< Peripheral Domain Access Control Word 0..Peripheral Domain Access Control Word 1, array offset: 0x1000, array step: index*0x8, index2*0x4, irregular array, not all indices are valid */
       uint8_t RESERVED_8[1568];
  struct {                                         /* offset: 0x2000, array step: 0x20 */
    __IO uint32_t MRGD_W[XRDC_MRGD_MRGD_Wx_COUNT];   /**< Memory Region Descriptor Word 0..Memory Region Descriptor Word 3, array offset: 0x2000, array step: index*0x20, index2*0x4 */
...
#define XRDC_MDA_W_DID_MASK                      (0x3U)
