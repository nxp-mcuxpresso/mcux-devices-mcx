...
#if !defined(MCXN537_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MCXN537_cm33_core1_H_
...
#endif  /* #if !defined(MCXN537_cm33_core1_H_) */
