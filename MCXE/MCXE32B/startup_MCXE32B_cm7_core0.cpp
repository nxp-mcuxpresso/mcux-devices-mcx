...
WEAK void MU2_A_TX_IRQHandler(void);
WEAK void MU2_A_RX_IRQHandler(void);
WEAK void MU2_A_IRQHandler(void);
WEAK void MU2_B_TX_IRQHandler(void);
WEAK void MU2_B_RX_IRQHandler(void);
...
void MU2_A_TX_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU2_A_RX_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU2_A_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU2_B_TX_DriverIRQHandler(void) ALIAS(DefaultISR);
void MU2_B_RX_DriverIRQHandler(void) ALIAS(DefaultISR);
...
#error Unsupported toolchain!
    ...
    MU2_A_TX_IRQHandler,           // 218: Ored tx interrupt to MUA
    MU2_A_RX_IRQHandler,           // 219: Ored rx interrupt to MUA
    MU2_A_IRQHandler,              // 220: ORed general purpose interrupt request to MUA
    MU2_B_TX_IRQHandler,           // 221: Ored tx interrupt to MUB
    MU2_B_RX_IRQHandler,           // 222: Ored rx interrupt to MUB
    MU2_B_IRQHandler,              // 223: ORed general purpose interrupt request to MUB
...
WEAK void MU2_A_TX_IRQHandler(void)
{
    MU2_A_TX_DriverIRQHandler();
}

WEAK void MU2_A_RX_IRQHandler(void)
{
    MU2_A_RX_DriverIRQHandler();
}

WEAK void MU2_A_IRQHandler(void)
{
    MU2_A_DriverIRQHandler();
}

WEAK void MU2_B_TX_IRQHandler(void)
{
    MU2_B_TX_DriverIRQHandler();
}

WEAK void MU2_B_RX_IRQHandler(void)
{
    MU2_B_RX_DriverIRQHandler();
}
