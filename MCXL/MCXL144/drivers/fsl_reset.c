...
void RESET_SetPeripheralReset(reset_ip_name_t peripheral)
{
    ...
    volatile uint32_t *pResetCtrl = &(MRCC->MRCC_GLB_RST0);
    ...
    if (regIndex == 0U)
    {
        MRCC->MRCC_GLB_RSTCLR0 = bitMask;
        pResetCtrl             = &(MRCC->MRCC_GLB_RST0);
    }
    else if (regIndex == 1U)
    {
        MRCC->MRCC_GLB_RSTCLR1 = bitMask;
        pResetCtrl             = &(MRCC->MRCC_GLB_RST1);
    }
    else
    {
...
void RESET_ClearPeripheralReset(reset_ip_name_t peripheral)
{
    ...
    if (regIndex == 0U)
    {
        MRCC->MRCC_GLB_RSTSET0 = bitMask;
        pResetCtrl             = &(MRCC->MRCC_GLB_RST0);
    }
    else if (regIndex == 1U)
    {
        MRCC->MRCC_GLB_RSTSET1 = bitMask;
        pResetCtrl             = &(MRCC->MRCC_GLB_RST1);
    }
    else
    {
