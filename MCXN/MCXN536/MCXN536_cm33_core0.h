...
#if !defined(MCXN536_cm33_core0_H_)  /* Check if memory map has not been already included */
#define MCXN536_cm33_core0_H_
...
#endif  /* #if !defined(MCXN536_cm33_core0_H_) */
