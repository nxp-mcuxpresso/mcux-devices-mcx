...
#define INPUTMUX1_QTMRA_COUNT                     4u
#define INPUTMUX1_SOC_GLUE_XOR0_INA_COUNT         2u
#define INPUTMUX1_QTMRB_COUNT                     4u
#define INPUTMUX1_ACMP0_TRIGM_COUNT               4u
#define INPUTMUX1_LPADC0_TRIGM_COUNT              4u
#define INPUTMUX1_AON_TRIG_OUTN_COUNT             2u

/** INPUTMUX1 - Register Layout Typedef */
typedef struct {
       uint8_t RESERVED_0[416];
  __IO uint32_t QTMR0_TMR[INPUTMUX1_QTMRA_COUNT];  /**< QTMR0 Input Connections, array offset: 0x1A0, array step: 0x4 */
  __IO uint32_t SOC_GLUE_XOR0_IN[INPUTMUX1_SOC_GLUE_XOR0_INA_COUNT]; /**< SOC_GLUE_XOR0 trigger input connections, array offset: 0x1B0, array step: 0x4 */
  ...
  __IO uint32_t QTMR1_TMR[INPUTMUX1_QTMRB_COUNT];  /**< QTMR1 Input Connections, array offset: 0x1C0, array step: 0x4 */
  ...
  __IO uint32_t ACMP0_TRIG[INPUTMUX1_ACMP0_TRIGM_COUNT]; /**< ACMP0 Input Connections, array offset: 0x260, array step: 0x4 */
       uint8_t RESERVED_2[16];
  __IO uint32_t LPADC0_TRIG[INPUTMUX1_LPADC0_TRIGM_COUNT]; /**< LPADC trigger input connections, array offset: 0x280, array step: 0x4 */
       uint8_t RESERVED_3[560];
  __IO uint32_t AON_TRIG_OUT[INPUTMUX1_AON_TRIG_OUTN_COUNT]; /**< AON Trigger Output Connections, array offset: 0x4C0, array step: 0x4 */
...
#define INPUTMUX1_QTMR0_TMR_INP_MASK             (0x3FU)
#define INPUTMUX1_QTMR0_TMR_INP_SHIFT            (0U)
 ...
 */
#define INPUTMUX1_QTMR0_TMR_INP(x)               (((uint32_t)(((uint32_t)(x)) << INPUTMUX1_QTMR0_TMR_INP_SHIFT)) & INPUTMUX1_QTMR0_TMR_INP_MASK)
/*! @} */

/* The count of INPUTMUX1_QTMR0_TMR */
#define INPUTMUX1_QTMR0_TMR_COUNT                (4U)

/*! @name SOC_GLUE_XOR0_IN - SOC_GLUE_XOR0 trigger input connections */
/*! @{ */

#define INPUTMUX1_SOC_GLUE_XOR0_IN_INP_MASK      (0x3FU)
#define INPUTMUX1_SOC_GLUE_XOR0_IN_INP_SHIFT     (0U)
 ...
 *  0b111001..LCSense_Sequencer_Primary_Trigger_glue_out is selected
 */
#define INPUTMUX1_SOC_GLUE_XOR0_IN_INP(x)        (((uint32_t)(((uint32_t)(x)) << INPUTMUX1_SOC_GLUE_XOR0_IN_INP_SHIFT)) & INPUTMUX1_SOC_GLUE_XOR0_IN_INP_MASK)
/*! @} */

/* The count of INPUTMUX1_SOC_GLUE_XOR0_IN */
#define INPUTMUX1_SOC_GLUE_XOR0_IN_COUNT         (2U)
...
#define INPUTMUX1_QTMR1_TMR_INP_MASK             (0x3FU)
#define INPUTMUX1_QTMR1_TMR_INP_SHIFT            (0U)
/*! INP - Input number for AON QTMR0
 *  0b000000..Reserved
 *  0b000001..AON_TRIG_IN0 input is selected
 *  0b000010..AON_TRIG_IN1 input is selected
 ...
 *  0b111001..LCSense_Sequencer_Primary_Trigger_glue_out is selected
 */
#define INPUTMUX1_QTMR1_TMR_INP(x)               (((uint32_t)(((uint32_t)(x)) << INPUTMUX1_QTMR1_TMR_INP_SHIFT)) & INPUTMUX1_QTMR1_TMR_INP_MASK)
/*! @} */

/* The count of INPUTMUX1_QTMR1_TMR */
#define INPUTMUX1_QTMR1_TMR_COUNT                (4U)
...
#define INPUTMUX1_ACMP0_TRIG_TRIGIN_MASK         (0x3FU)
#define INPUTMUX1_ACMP0_TRIG_TRIGIN_SHIFT        (0U)
 ...
 *  0b100011..Reserved
 */
#define INPUTMUX1_ACMP0_TRIG_TRIGIN(x)           (((uint32_t)(((uint32_t)(x)) << INPUTMUX1_ACMP0_TRIG_TRIGIN_SHIFT)) & INPUTMUX1_ACMP0_TRIG_TRIGIN_MASK)
/*! @} */

/* The count of INPUTMUX1_ACMP0_TRIG */
#define INPUTMUX1_ACMP0_TRIG_COUNT               (4U)

/*! @name LPADC0_TRIG - LPADC trigger input connections */
/*! @{ */

#define INPUTMUX1_LPADC0_TRIG_TRIGIN_MASK        (0x1FU)
#define INPUTMUX1_LPADC0_TRIG_TRIGIN_SHIFT       (0U)
 ...
 *  0b11110..Reserved
 */
#define INPUTMUX1_LPADC0_TRIG_TRIGIN(x)          (((uint32_t)(((uint32_t)(x)) << INPUTMUX1_LPADC0_TRIG_TRIGIN_SHIFT)) & INPUTMUX1_LPADC0_TRIG_TRIGIN_MASK)
/*! @} */

/* The count of INPUTMUX1_LPADC0_TRIG */
#define INPUTMUX1_LPADC0_TRIG_COUNT              (4U)

/*! @name AON_TRIG_OUT - AON Trigger Output Connections */
/*! @{ */

#define INPUTMUX1_AON_TRIG_OUT_INP_MASK          (0x1FU)
#define INPUTMUX1_AON_TRIG_OUT_INP_SHIFT         (0U)
 ...
 */
#define INPUTMUX1_AON_TRIG_OUT_INP(x)            (((uint32_t)(((uint32_t)(x)) << INPUTMUX1_AON_TRIG_OUT_INP_SHIFT)) & INPUTMUX1_AON_TRIG_OUT_INP_MASK)
/*! @} */

/* The count of INPUTMUX1_AON_TRIG_OUT */
#define INPUTMUX1_AON_TRIG_OUT_COUNT             (2U)
