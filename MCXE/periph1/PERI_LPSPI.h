 ...
 *  0b0..HREQ pin or input trigger is active high
 *  0b1..HREQ pin or input trigger is active low
 */
 ...
 *  0b0..HREQ pin is configured as input
 *  0b1..HREQ pin is configured as output
 */
...
/*! NOSTALL - No Stall
 *  0b0..Transfers stall when the transmit FIFO is empty or the receive FIFO is full
 *  0b1..Transfers do not stall, allowing transmit FIFO underruns or receive FIFO overruns to occur
 */
 ...
 *  0b0..Partial words in the receive shift register when PCS negates are discarded.
 *  0b1..Partial words in the receive shift register when PCS negates are stored in the receive FIFO.
 */
 ...
 *  0b00..PCS[7:2] are configured for chip select function
 *  0b01..PCS[3:2] are configured for half-duplex 4-bit transfers (PCS[3:2] = DATA[3:2])
 *  0b11..PCS[7:2] are configured for half-duplex 4-bit and 8-bit transfers (PCS[7:2] = DATA[7:2])
 */
 ...
 *  0b000..Transfer using PCS[0]
 *  0b001..Transfer using PCS[1]
 *  0b010..Transfer using PCS[2]
 *  0b011..Transfer using PCS[3]
 *  0b100..Transfer using PCS[4]
 *  0b101..Transfer using PCS[5]
 *  0b110..Transfer using PCS[6]
 *  0b111..Transfer using PCS[7]
 */
