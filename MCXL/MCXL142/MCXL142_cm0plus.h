...
#if !defined(MCXL142_cm0plus_H_)  /* Check if memory map has not been already included */
#define MCXL142_cm0plus_H_
...
#endif  /* #if !defined(MCXL142_cm0plus_H_) */
