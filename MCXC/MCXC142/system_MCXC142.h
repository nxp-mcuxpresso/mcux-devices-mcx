 ...
 * @version 1.6
 * @date 2016-06-24
 * @brief Device specific configuration file for MCXC142 (header file)
 *
...
#ifndef _SYSTEM_MCXC142_H_
#define _SYSTEM_MCXC142_H_                       /**< Symbol preventing repeated inclusion */
