...
#ifndef _MCXE246_FEATURES_H_
#define _MCXE246_FEATURES_H_
...
/* @brief Has separate DMA RX and TX requests. */
#define FSL_FEATURE_LPUART_HAS_SEPARATE_DMA_RX_TX_REQn(x) (false)
...
#define FSL_FEATURE_SIM_OPT_FTM_COUNT (6)
