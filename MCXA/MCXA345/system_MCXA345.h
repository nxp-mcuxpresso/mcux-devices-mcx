 ...
 * @version 1.0
 * @date 2024-11-21
 * @brief Device specific configuration file for MCXA345 (header file)
 *
...
#ifndef _SYSTEM_MCXA345_H_
#define _SYSTEM_MCXA345_H_                       /**< Symbol preventing repeated inclusion */
