...
#ifndef _MCXL143_FEATURES_H_
#define _MCXL143_FEATURES_H_
...
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_SIZE (0x20000u)
...
#define FSL_FEATURE_GLIKEY_HAS_EIGHT_STEPS (1u)
