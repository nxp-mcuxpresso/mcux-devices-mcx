; -------------------------------------------------------------------------
;  @file:    startup_MCXW727C_cm33_core0.s
...
__vector_table_0x1c
        ...
        DCD     DMA0_CH0_IRQHandler                           ;DMA0 channel 0 error or transfer complete
        DCD     DMA0_CH1_IRQHandler                           ;DMA0 channel 1 error or transfer complete
        DCD     DMA0_CH2_IRQHandler                           ;DMA0 channel 2 error or transfer complete
        DCD     DMA0_CH3_IRQHandler                           ;DMA0 channel 3 error or transfer complete
        DCD     DMA0_CH4_IRQHandler                           ;DMA0 channel 4 error or transfer complete
        DCD     DMA0_CH5_IRQHandler                           ;DMA0 channel 5 error or transfer complete
        DCD     DMA0_CH6_IRQHandler                           ;DMA0 channel 6 error or transfer complete
        DCD     DMA0_CH7_IRQHandler                           ;DMA0 channel 7 error or transfer complete
        DCD     DMA0_CH8_IRQHandler                           ;DMA0 channel 8 error or transfer complete
        DCD     DMA0_CH9_IRQHandler                           ;DMA0 channel 9 error or transfer complete
        DCD     DMA0_CH10_IRQHandler                          ;DMA0 channel 10 error or transfer complete
        DCD     DMA0_CH11_IRQHandler                          ;DMA0 channel 11 error or transfer complete
        DCD     DMA0_CH12_IRQHandler                          ;DMA0 channel 12 error or transfer complete
        DCD     DMA0_CH13_IRQHandler                          ;DMA0 channel 13 error or transfer complete
        DCD     DMA0_CH14_IRQHandler                          ;DMA0 channel 14 error or transfer complete
        DCD     DMA0_CH15_IRQHandler                          ;DMA0 channel 15 error or transfer complete
        ...
        DCD     LPCMP0_IRQHandler                             ;Comparator - General Purpose0 interrupt
        DCD     LPCMP1_IRQHandler                             ;Comparator - General Purpose1 interrupt
        ...
        DCD     DSP_IRQHandler                                ;LCE interrupt
        DCD     DefaultISR                                    ;94
        DCD     DefaultISR                                    ;95
        DCD     DefaultISR                                    ;96
        DCD     DefaultISR                                    ;97
