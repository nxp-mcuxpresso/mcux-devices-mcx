...
/*! @name Driver version */
/*@{*/
/*! @brief ipmq driver version 2.1.0 */
#define FSL_IPMQ_DRIVER_VERSION (MAKE_VERSION(2, 1, 0))
/*@}*/
...
typedef enum _ipmq_ret_value
{
    ...
    kIPMQ_Ret_Busy,                    /*!< IPMQ is busy. */
    kIPMQ_Ret_SendSuccess,             /*!< Message send to AON successfully. */
    kIPMQ_Ret_NoMsgSent,               /*!< No message sent to AON. */
} ipmq_ret_value_t;
...
typedef struct _ipmq_interrupt_cb
{
    ...
    void (*extIntAssert)(void); /*!< Callback function for EXT_INT assert. */
    void (*rtcAlarm0)(void);    /*!< Callback function for RTC alarm 0 interrupts. */
    void (*rtcAlarm1)(void);    /*!< Callback function for RTC alarm 1 interrupts. */
    void (*gpioIntA)(void); /*!< Callback function for GPIO interrupt A. */
    void (*gpioIntB)(void); /*!< Callback function for GPIO interrupt B. */
 ...
 * @retval kIPMQ_Ret_SendSuccess Message already send to AON successfully.
 */
 ...
 * @retval kIPMQ_Ret_NoMsgSent No message sent to AON, please invoke IPMQ_SendMessage() or IPMQ_SendMessage2Payload()
            to start send-receive operation.
 */
