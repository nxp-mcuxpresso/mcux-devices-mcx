...
#if !defined(MCXW727C_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MCXW727C_cm33_core1_H_
...
#endif  /* #if !defined(MCXW727C_cm33_core1_H_) */
