...
status_t CLOCK_SetMcgliteConfig(mcglite_config_t const *targetConfig)
{
    ...
    {
        MCG->C1 = (uint8_t)((MCG->C1 & (uint8_t)(~MCG_C1_CLKS_MASK)) | MCG_C1_CLKS(kMCGLITE_ClkSrcHirc));
    ...
    MCG->MC = MCG_MC_HIRCEN((uint8_t)(targetConfig->hircEnableInNotHircMode)) | MCG_MC_LIRC_DIV2(targetConfig->lircDiv2);
    MCG->C2 = (uint8_t)((MCG->C2 & (uint8_t)(~MCG_C2_IRCS_MASK)) | MCG_C2_IRCS(targetConfig->ircs));
