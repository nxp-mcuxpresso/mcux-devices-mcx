...
#if !defined(MCXW727D_cm33_core0_H_)  /* Check if memory map has not been already included */
#define MCXW727D_cm33_core0_H_
...
#include "PERI_XCVR_ZBDEMOD.h"
#include "PERI_ZLL.h"

#endif  /* #if !defined(MCXW727D_cm33_core0_H_) */
