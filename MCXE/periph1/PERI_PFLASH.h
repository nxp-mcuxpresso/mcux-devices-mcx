...
/*! DERR_SUP - Data Error Suppression
 *  0b0..Reports ECC events on data flash memory accesses
 *  0b1..Single-bit and multi-bit ECC events on data flash memory accesses are suppressed
 */
...
#define PFLASH_PFCBLK_SPELOCK_COUNT              (5U)
...
#define PFLASH_PFCBLK_SSPELOCK_COUNT             (4U)
...
#define PFLASH_PFCBLK_SETSLOCK_COUNT             (5U)
...
#define PFLASH_PFCBLK_SSETSLOCK_COUNT            (4U)
...
#define PFLASH_PFCBLK_LOCKMASTER_S_COUNT         (5U)
...
#define PFLASH_PFCBLK_LOCKMASTER_SS_COUNT        (4U)

/* The count of PFLASH_PFCBLK_LOCKMASTER_SS */
#define PFLASH_PFCBLK_LOCKMASTER_SS_COUNT2       (3U)
