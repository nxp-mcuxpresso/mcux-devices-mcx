...
#if !defined(MCXL253_cm0plus_H_)  /* Check if memory map has not been already included */
#define MCXL253_cm0plus_H_
...
#endif  /* #if !defined(MCXL253_cm0plus_H_) */
