 ...
 * @version 1.0
 * @date 2024-03-26
 * @brief Device specific configuration file for MCXA256 (header file)
 *
...
#ifndef _SYSTEM_MCXA256_H_
#define _SYSTEM_MCXA256_H_                       /**< Symbol preventing repeated inclusion */
