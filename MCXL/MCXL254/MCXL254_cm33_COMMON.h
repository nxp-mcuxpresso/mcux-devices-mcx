...
#if !defined(MCXL254_CM33_COMMON_H_)
#define MCXL254_CM33_COMMON_H_                   /**< Symbol preventing repeated inclusion */
...
#include "system_MCXL254_cm33.h"       /* Device specific configuration file */
