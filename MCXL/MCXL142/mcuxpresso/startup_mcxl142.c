//*****************************************************************************
// MCXL142 startup code for use with MCUXpresso IDE
//
// Version : 130324
//*****************************************************************************
//
...
WEAK void PORT_IRQHandler(void);
...
void PORT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    FLEXPWM0_RELOAD_ERROR_IRQHandler,  // 60: eFlexPWM0_reload_error interrupt
    FLEXPWM0_FAULT_IRQHandler,         // 61: eFlexPWM0_fault interrupt
    FLEXPWM0_SUBMODULE0_IRQHandler,    // 62: eFlexPWM0 Submodule 0 capture/compare/reload interrupt
    FLEXPWM0_SUBMODULE1_IRQHandler,    // 63: eFlexPWM0 Submodule 1 capture/compare/reload interrupt
    FLEXPWM0_SUBMODULE2_IRQHandler,    // 64: eFlexPWM0 Submodule 2 capture/compare/reload interrupt
    ...
    PORT_IRQHandler,                   // 92: PORT0~PORTx EFT interrupts
