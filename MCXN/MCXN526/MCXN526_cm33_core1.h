...
#if !defined(MCXN526_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MCXN526_cm33_core1_H_
...
#endif  /* #if !defined(MCXN526_cm33_core1_H_) */
