...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MCXW236B
**
...
/*!
 * @file MCXW236B_COMMON.h
 * @version 1.0
 * @date 2022-03-08
 * @brief CMSIS Peripheral Access Layer for MCXW236B
 *
 * CMSIS Peripheral Access Layer for MCXW236B
 */

#if !defined(MCXW236B_COMMON_H_)
#define MCXW236B_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_MCXW236B.h"            /* Device specific configuration file */
...
#define MCXW236B_SERIES
/* CPU specific feature definitions */
#include "MCXW236B_features.h"
