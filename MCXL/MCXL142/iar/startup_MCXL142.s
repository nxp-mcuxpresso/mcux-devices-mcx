...
__vector_table_0x1c
        ...
        DCD     Reserved32_IRQHandler                         ;Reserved interrupt 32
        ...
        DCD     FLEXPWM0_RELOAD_ERROR_IRQHandler              ;eFlexPWM0_reload_error interrupt
        DCD     FLEXPWM0_FAULT_IRQHandler                     ;eFlexPWM0_fault interrupt
        DCD     FLEXPWM0_SUBMODULE0_IRQHandler                ;eFlexPWM0 Submodule 0 capture/compare/reload interrupt
        DCD     FLEXPWM0_SUBMODULE1_IRQHandler                ;eFlexPWM0 Submodule 1 capture/compare/reload interrupt
        DCD     FLEXPWM0_SUBMODULE2_IRQHandler                ;eFlexPWM0 Submodule 2 capture/compare/reload interrupt
        DCD     Reserved65_IRQHandler                         ;Reserved interrupt 65
        ...
        DCD     PORT_IRQHandler                               ;PORT0~PORTx EFT interrupts
...
Reserved25_IRQHandler
        ...
        PUBWEAK Reserved26_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
Reserved26_IRQHandler
        LDR     R0, =Reserved26_DriverIRQHandler
        BX      R0
...
Reserved89_IRQHandler
        ...
        PUBWEAK Reserved90_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
Reserved90_IRQHandler
        LDR     R0, =Reserved90_DriverIRQHandler
        BX      R0
...
Reserved91_IRQHandler
        ...
        PUBWEAK PORT_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
PORT_IRQHandler
        LDR     R0, =PORT_DriverIRQHandler
        BX      R0
