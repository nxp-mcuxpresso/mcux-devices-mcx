...
#if !defined(MC_CGM_H_)
#define MC_CGM_H_                                /**< Symbol preventing repeated inclusion */
...
/*! DIV_STAT - Divider status for clock mux 2
 *  0b0..No divider configuration update is pending.
 *  0b1..Divider configuration update on at least one divider associated with this multiplexer is pending.
 */
...
/*! DIV_STAT - Divider status for clock mux 4
 *  0b0..No divider configuration update is pending.
 *  0b1..Divider configuration update on at least one divider associated with this multiplexer is pending.
 */
 ...
 *  0b010111..AIPS_SLOW_CLK
 *  0b011000..EMAC_RMII_TX_CLK
 *  0b011001..EMAC_RX_CLK
 *  0b110011..Reserved
 *  0b110100..Reserved
 *  0b110101..Reserved
 *  0b110110..Reserved
...
/*! DIV_STAT - Divider status for clock mux 7
 *  0b0..No divider configuration update is pending.
 *  0b1..Divider configuration update on at least one divider associated with this multiplexer is pending.
 */
...
/*! DIV_STAT - Divider status for clock mux 8
 *  0b0..No divider configuration update is pending.
 *  0b1..Divider configuration update on at least one divider associated with this multiplexer is pending.
 */
...
/*! DIV_STAT - Divider status for clock mux 9
 *  0b0..No divider configuration update is pending.
 *  0b1..Divider configuration update on at least one divider associated with this multiplexer is pending.
 */
...
/*! DIV_STAT - Divider status for clock mux 10
 *  0b0..No divider configuration update is pending.
 *  0b1..Divider configuration update on at least one divider associated with this multiplexer is pending.
 */
