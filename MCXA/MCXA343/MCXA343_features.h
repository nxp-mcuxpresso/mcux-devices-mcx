...
#ifndef _MCXA343_FEATURES_H_
#define _MCXA343_FEATURES_H_

/* SOC module features */

#if defined(CPU_MCXA343VFM)
...
#elif defined(CPU_MCXA343VLF) || defined(CPU_MCXA343VLH) || defined(CPU_MCXA343VLL)
    /* @brief AOI availability on the SoC. */
    #define FSL_FEATURE_SOC_AOI_COUNT (2)
    /* @brief CDOG availability on the SoC. */
    #define FSL_FEATURE_SOC_CDOG_COUNT (1)
...
#define FSL_FEATURE_SYSCON_FLASH_SIZE_BYTES (122880)
