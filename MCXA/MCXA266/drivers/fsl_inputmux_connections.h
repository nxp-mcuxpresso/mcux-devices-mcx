...
typedef enum _inputmux_connection_t
{
    ...
    kINPUTMUX_Pwm1Sm3OutTrig0ToAoi1Mux    = 79U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm3OutTrig1ToAoi1Mux    = 80U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm0AOutToAoi1Mux        = 81U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm0BOutToAoi1Mux        = 82U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm1AOutToAoi1Mux        = 83U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm1BOutToAoi1Mux        = 84U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm2AOutToAoi1Mux        = 85U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm2BOutToAoi1Mux        = 86U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm3AOutToAoi1Mux        = 87U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Pwm1Sm3BOutToAoi1Mux        = 88U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc2Tcomp0ToAoi1Mux         = 89U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc2Tcomp1ToAoi1Mux         = 90U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc2Tcomp2ToAoi1Mux         = 91U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc2Tcomp3ToAoi1Mux         = 92U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc3Tcomp0ToAoi1Mux         = 93U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc3Tcomp1ToAoi1Mux         = 94U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc3Tcomp2ToAoi1Mux         = 95U + (AOI1_MUX_REG << PMUX_SHIFT),
    kINPUTMUX_Adc3Tcomp3ToAoi1Mux         = 96U + (AOI1_MUX_REG << PMUX_SHIFT),
