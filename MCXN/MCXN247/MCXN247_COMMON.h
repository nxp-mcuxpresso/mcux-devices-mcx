...
/*!
 * @file MCXN247_COMMON.h
 * @version 3.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MCXN247
 *
 * CMSIS Peripheral Access Layer for MCXN247
 */

#if !defined(MCXN247_COMMON_H_)
#define MCXN247_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_MCXN247.h"            /* Device specific configuration file */
...
#ifndef MCXN247_SERIES
#define MCXN247_SERIES
#endif
/* CPU specific feature definitions */
#include "MCXN247_features.h"
...
/* OPAMP - Peripheral instance base addresses */
  ...
  /** Array initializer of OPAMP peripheral base addresses */
  #define OPAMP_BASE_ADDRS_NS                      { OPAMP0_BASE_NS, OPAMP1_BASE_NS }
  /** Array initializer of OPAMP peripheral base pointers */
  #define OPAMP_BASE_PTRS_NS                       { OPAMP0_NS, OPAMP1_NS }
#else
  /** Peripheral OPAMP0 base address */
