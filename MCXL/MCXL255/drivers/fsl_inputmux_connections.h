...
#warning "This is just copied from L10 and most likely not valid for L20."
...
typedef enum _inputmux_connection_t
{
    ...
    kINPUTMUX_Xtal32KToFreqmeasRef         = 4u + (FREQMEAS_REF_REG << PMUX_SHIFT),
    ...
    kINPUTMUX_Xtal32KToFreqmeasTar         = 4u + (FREQMEAS_REF_REG << PMUX_SHIFT),
