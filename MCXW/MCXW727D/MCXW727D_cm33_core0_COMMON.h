/*
** ###################################################################
**     Processor:           MCXW727DMFTA_cm33_core0
...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MCXW727D_cm33_core0
**
...
/*!
 * @file MCXW727D_cm33_core0_COMMON.h
 * @version 2.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MCXW727D_cm33_core0
 *
 * CMSIS Peripheral Access Layer for MCXW727D_cm33_core0
 */

#if !defined(MCXW727D_CM33_CORE0_COMMON_H_)
#define MCXW727D_CM33_CORE0_COMMON_H_            /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  RF_802_15_4_IRQn             = 53,               /**< Radio Frequency 2.4GHz - 802.15.4 Link Layer interrupt */
...
#include "system_MCXW727D_cm33_core0.h" /* Device specific configuration file */
...
#ifndef MCXW727D_cm33_core0_SERIES
#define MCXW727D_cm33_core0_SERIES
#endif
/* CPU specific feature definitions */
#include "MCXW727D_cm33_core0_features.h"
...
/* MU - Peripheral instance base addresses */
  ...
  #define MUA_BASE                                 (0x50053000u)
  /** Peripheral MUA base address */
  #define MUA_BASE_NS                              (0x40053000u)
...
/* XCVR_ZBDEMOD - Peripheral instance base addresses */
  ...
  #define XCVR_ZBDEMOD_BASE                        (0x58A07500u)
  /** Peripheral XCVR_ZBDEMOD base address */
  #define XCVR_ZBDEMOD_BASE_NS                     (0x48A07500u)
...
#else
  /** Peripheral XCVR_ZBDEMOD base address */
  #define XCVR_ZBDEMOD_BASE                        (0x48A07500u)
  /** Peripheral XCVR_ZBDEMOD base pointer */
  #define XCVR_ZBDEMOD                             ((XCVR_ZBDEMOD_Type *)XCVR_ZBDEMOD_BASE)
  /** Array initializer of XCVR_ZBDEMOD peripheral base addresses */
  #define XCVR_ZBDEMOD_BASE_ADDRS                  { XCVR_ZBDEMOD_BASE }
...
/* ZLL - Peripheral instance base addresses */
  ...
  #define ZLL_BASE                                 (0x58A01000u)
  /** Peripheral ZLL base address */
  #define ZLL_BASE_NS                              (0x48A01000u)
...
#if defined(MCXW727A_cm33_core0_H_) || defined(MCXW727C_cm33_core0_H_) || defined(MCXW727D_cm33_core0_H_)
#define RADIO_IS_GEN_4P7 (1)
#define NXP_RADIO_GEN (470)
#define IS_APP_CORE (1)
#define IS_RADIO_CORE (0)
#ifndef MCXW72_core0_SERIES
#define MCXW72_core0_SERIES
#endif
...
#endif  /* MCXW727D_CM33_CORE0_COMMON_H_ */
