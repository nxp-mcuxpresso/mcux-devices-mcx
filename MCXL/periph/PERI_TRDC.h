...
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x1CC */
    __IO uint32_t MBC_MEM_GLBCFG[TRDC_MBC_INDEX_MBC_MEM_GLBCFG_COUNT];   /**< MBC Global Configuration Register, array offset: 0x0, array step: index*0x1CC, index2*0x4 */
    ...
    __IO uint32_t MBC_MEMN_GLBAC[TRDC_MBC_INDEX_MBC_MEMN_GLBAC_COUNT];   /**< MBC Global Access Control, array offset: 0x20, array step: index*0x1CC, index2*0x4 */
...
#define TRDC_MBC_NSE_BLK_INDEX_COUNT             (1U)
...
#define TRDC_MBC_NSE_BLK_SET_COUNT               (1U)
...
#define TRDC_MBC_NSE_BLK_CLR_COUNT               (1U)
...
#define TRDC_MBC_NSE_BLK_CLR_ALL_COUNT           (1U)
...
/* The count of TRDC_MBC_DOM0_MEM0_BLK_CFG_W */
#define TRDC_MBC_DOM0_MEM0_BLK_CFG_W_COUNT2      (4U)
...
#define TRDC_MBC_DOM0_MEM0_BLK_NSE_W_COUNT       (1U)

/* The count of TRDC_MBC_DOM0_MEM0_BLK_NSE_W */
#define TRDC_MBC_DOM0_MEM0_BLK_NSE_W_COUNT2      (1U)
...
#define TRDC_MBC_DOM0_MEM1_BLK_NSE_W_COUNT       (1U)
...
#define TRDC_MBC_DOM0_MEM2_BLK_NSE_W_COUNT       (1U)
