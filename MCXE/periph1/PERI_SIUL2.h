...
#if !defined(SIUL2_H_)
#define SIUL2_H_                                 /**< Symbol preventing repeated inclusion */
...
#define SIUL2_GPDO_COUNT                          220u
#define SIUL2_GPDI_COUNT                          220u
#define SIUL2_PGPDO_COUNT                         14u
#define SIUL2_PGPDI_COUNT                         14u
...
typedef struct {
  ...
  __IO uint32_t MSCR[SIUL2_MSCR_COUNT];            /**< SIUL2 Multiplexed Signal Configuration Register, array offset: 0x240, array step: 0x4, valid indices: [0-37, 40-219] */
       uint8_t RESERVED_10[1168];
  __IO uint32_t IMCR[SIUL2_IMCR_COUNT];            /**< SIUL2 Input Multiplexed Signal Configuration Register, array offset: 0xA40, array step: 0x4, valid indices: [0-5, 16-71, 80-103, 112-135, 144-149, 152-202, 211-268, 289-309, 315-325, 343-378] */
       uint8_t RESERVED_11[724];
  __IO uint8_t GPDO[SIUL2_GPDO_COUNT];             /**< SIUL2 GPIO Pad Data Output Register, array offset: 0x1300, array step: 0x1, valid indices: [0-35, 38-219] */
       uint8_t RESERVED_12[292];
  __I  uint8_t GPDI[SIUL2_GPDI_COUNT];             /**< SIUL2 GPIO Pad Data Input Register, array offset: 0x1500, array step: 0x1, valid indices: [0-35, 38-219] */
  ...
  __IO uint32_t MPGPDO[SIUL2_MPGPDO_COUNT];        /**< SIUL2 Masked Parallel GPIO Pad Data Out Register, array offset: 0x1780, array step: 0x4 */
} SIUL2_Type;
