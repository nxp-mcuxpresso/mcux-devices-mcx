...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MCXL143
**
...
/*!
 * @file MCXL143_COMMON.h
 * @version 1.0
 * @date 2023-01-09
 * @brief CMSIS Peripheral Access Layer for MCXL143
 *
 * CMSIS Peripheral Access Layer for MCXL143
 */

#if !defined(MCXL143_COMMON_H_)
#define MCXL143_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_MCXL143.h"            /* Device specific configuration file */

#define MCXL143_SERIES
/* CPU specific feature definitions */
#include "MCXL143_features.h"
