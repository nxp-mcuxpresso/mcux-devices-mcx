...
#ifndef _MCXA354_FEATURES_H_
#define _MCXA354_FEATURES_H_

/* SOC module features */

#if defined(CPU_MCXA354VFM)
...
#elif defined(CPU_MCXA354VLF) || defined(CPU_MCXA354VLH) || defined(CPU_MCXA354VLL)
    /* @brief AOI availability on the SoC. */
    #define FSL_FEATURE_SOC_AOI_COUNT (2)
    /* @brief CDOG availability on the SoC. */
    #define FSL_FEATURE_SOC_CDOG_COUNT (1)
...
#define FSL_FEATURE_SYSCON_FLASH_SIZE_BYTES (253952)
