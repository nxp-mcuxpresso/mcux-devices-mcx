...
/*!
 * @file MCXA143_COMMON.h
 * @version 1.0
 * @date 2022-03-29
 * @brief CMSIS Peripheral Access Layer for MCXA143
 *
 * CMSIS Peripheral Access Layer for MCXA143
 */

#if !defined(MCXA143_COMMON_H_)
#define MCXA143_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_MCXA143.h"            /* Device specific configuration file */
