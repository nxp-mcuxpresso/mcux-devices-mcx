 ...
 * @version 2.0
 * @date 2024-10-29
 * @brief Device specific configuration file for MCXA566 (header file)
 *
...
#ifndef _SYSTEM_MCXA566_H_
#define _SYSTEM_MCXA566_H_                       /**< Symbol preventing repeated inclusion */
