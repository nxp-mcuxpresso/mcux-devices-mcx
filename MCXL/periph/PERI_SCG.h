 ...
 *  0b0..SIRC is disabled in Deep Sleep 0 mode
 *  0b1..SIRC is enabled in Deep Sleep 0 mode
 */
 ...
 *  0b0..FIRC is disabled in Deep Sleep 0 mode
 *  0b1..FIRC is enabled in Deep Sleep 0 mode
 */
...
#define SCG_FIRCCFG_FREQ_SEL_MASK                (0x6U)
#define SCG_FIRCCFG_FREQ_SEL_SHIFT               (1U)
/*! FREQ_SEL - Frequency select
 *  0b11..48 MHz FIRC clock selected
 *  0b10..40 MHz FIRC clock selected
 *  0b01..Reserved
 *  0b00..36 MHz FIRC clock selected
 */
#define SCG_FIRCCFG_FREQ_SEL(x)                  (((uint32_t)(((uint32_t)(x)) << SCG_FIRCCFG_FREQ_SEL_SHIFT)) & SCG_FIRCCFG_FREQ_SEL_MASK)

#define SCG_FIRCCFG_DIV2_DIV4_SEL_MASK           (0x10U)
#define SCG_FIRCCFG_DIV2_DIV4_SEL_SHIFT          (4U)
/*! DIV2_DIV4_SEL - FIRC Divider Select
 *  0b0..By-2-divider selected
 *  0b1..By-4-divider selected
 */
#define SCG_FIRCCFG_DIV2_DIV4_SEL(x)             (((uint32_t)(((uint32_t)(x)) << SCG_FIRCCFG_DIV2_DIV4_SEL_SHIFT)) & SCG_FIRCCFG_DIV2_DIV4_SEL_MASK)
/*! @} */
