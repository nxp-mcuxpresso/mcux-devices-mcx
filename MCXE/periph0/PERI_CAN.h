...
typedef struct {
  ...
  __IO uint32_t CBT;                               /**< CAN Bit Timing Register, offset: 0x50 */
       uint8_t RESERVED_4[2092];
  __IO uint32_t RXIMR[CAN_RXIMR_COUNT];            /**< Rx Individual Mask Registers, array offset: 0x880, array step: 0x4 */
       uint8_t RESERVED_5[512];
  __IO uint32_t CTRL1_PN;                          /**< Pretended Networking Control 1 Register, offset: 0xB00, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t CTRL2_PN;                          /**< Pretended Networking Control 2 Register, offset: 0xB04, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t WU_MTC;                            /**< Pretended Networking Wake Up Match Register, offset: 0xB08, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t FLT_ID1;                           /**< Pretended Networking ID Filter 1 Register, offset: 0xB0C, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t FLT_DLC;                           /**< Pretended Networking DLC Filter Register, offset: 0xB10, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t PL1_LO;                            /**< Pretended Networking Payload Low Filter 1 Register, offset: 0xB14, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t PL1_HI;                            /**< Pretended Networking Payload High Filter 1 Register, offset: 0xB18, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t FLT_ID2_IDMASK;                    /**< Pretended Networking ID Filter 2 Register / ID Mask Register, offset: 0xB1C, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t PL2_PLMASK_LO;                     /**< Pretended Networking Payload Low Filter 2 Register / Payload Low Mask register, offset: 0xB20, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  __IO uint32_t PL2_PLMASK_HI;                     /**< Pretended Networking Payload High Filter 2 low order bits / Payload High Mask register, offset: 0xB24, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
       uint8_t RESERVED_6[24];
  struct {                                         /* offset: 0xB40, array step: 0x10 */
    __I  uint32_t CS;                                /**< Wake Up Message Buffer register for C/S, array offset: 0xB40, array step: 0x10, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
    __I  uint32_t ID;                                /**< Wake Up Message Buffer Register for ID, array offset: 0xB44, array step: 0x10, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
    __I  uint32_t D03;                               /**< Wake Up Message Buffer Register for Data 0-3, array offset: 0xB48, array step: 0x10, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
    __I  uint32_t D47;                               /**< Wake Up Message Buffer Register Data 4-7, array offset: 0xB4C, array step: 0x10, available only on: FlexCAN0/FLEXCAN0 (missing on FlexCAN1/FLEXCAN1, FlexCAN2/FLEXCAN2) */
  } WMB[CAN_WMB_COUNT];
...
/*! @name CS - Wake Up Message Buffer register for C/S */
/*! @{ */
...
/* The count of CAN_CS */
#define CAN_CS_COUNT                             (4U)

/*! @name ID - Wake Up Message Buffer Register for ID */
/*! @{ */

#define CAN_ID_ID_MASK                           (0x1FFFFFFFU)
#define CAN_ID_ID_SHIFT                          (0U)
/*! ID - Received ID under Pretended Networking mode */
#define CAN_ID_ID(x)                             (((uint32_t)(((uint32_t)(x)) << CAN_ID_ID_SHIFT)) & CAN_ID_ID_MASK)
/*! @} */

/* The count of CAN_ID */
#define CAN_ID_COUNT                             (4U)

/*! @name D03 - Wake Up Message Buffer Register for Data 0-3 */
/*! @{ */

#define CAN_D03_Data_byte_3_MASK                 (0xFFU)
#define CAN_D03_Data_byte_3_SHIFT                (0U)
/*! Data_byte_3 - Received payload corresponding to the data byte 3 under Pretended Networking mode */
#define CAN_D03_Data_byte_3(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D03_Data_byte_3_SHIFT)) & CAN_D03_Data_byte_3_MASK)

#define CAN_D03_Data_byte_2_MASK                 (0xFF00U)
#define CAN_D03_Data_byte_2_SHIFT                (8U)
/*! Data_byte_2 - Received payload corresponding to the data byte 2 under Pretended Networking mode */
#define CAN_D03_Data_byte_2(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D03_Data_byte_2_SHIFT)) & CAN_D03_Data_byte_2_MASK)

#define CAN_D03_Data_byte_1_MASK                 (0xFF0000U)
#define CAN_D03_Data_byte_1_SHIFT                (16U)
/*! Data_byte_1 - Received payload corresponding to the data byte 1 under Pretended Networking mode */
#define CAN_D03_Data_byte_1(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D03_Data_byte_1_SHIFT)) & CAN_D03_Data_byte_1_MASK)

#define CAN_D03_Data_byte_0_MASK                 (0xFF000000U)
#define CAN_D03_Data_byte_0_SHIFT                (24U)
/*! Data_byte_0 - Received payload corresponding to the data byte 0 under Pretended Networking mode */
#define CAN_D03_Data_byte_0(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D03_Data_byte_0_SHIFT)) & CAN_D03_Data_byte_0_MASK)
/*! @} */

/* The count of CAN_D03 */
#define CAN_D03_COUNT                            (4U)

/*! @name D47 - Wake Up Message Buffer Register Data 4-7 */
/*! @{ */

#define CAN_D47_Data_byte_7_MASK                 (0xFFU)
#define CAN_D47_Data_byte_7_SHIFT                (0U)
/*! Data_byte_7 - Received payload corresponding to the data byte 7 under Pretended Networking mode */
#define CAN_D47_Data_byte_7(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D47_Data_byte_7_SHIFT)) & CAN_D47_Data_byte_7_MASK)

#define CAN_D47_Data_byte_6_MASK                 (0xFF00U)
#define CAN_D47_Data_byte_6_SHIFT                (8U)
/*! Data_byte_6 - Received payload corresponding to the data byte 6 under Pretended Networking mode */
#define CAN_D47_Data_byte_6(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D47_Data_byte_6_SHIFT)) & CAN_D47_Data_byte_6_MASK)

#define CAN_D47_Data_byte_5_MASK                 (0xFF0000U)
#define CAN_D47_Data_byte_5_SHIFT                (16U)
/*! Data_byte_5 - Received payload corresponding to the data byte 5 under Pretended Networking mode */
#define CAN_D47_Data_byte_5(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D47_Data_byte_5_SHIFT)) & CAN_D47_Data_byte_5_MASK)

#define CAN_D47_Data_byte_4_MASK                 (0xFF000000U)
#define CAN_D47_Data_byte_4_SHIFT                (24U)
/*! Data_byte_4 - Received payload corresponding to the data byte 4 under Pretended Networking mode */
#define CAN_D47_Data_byte_4(x)                   (((uint32_t)(((uint32_t)(x)) << CAN_D47_Data_byte_4_SHIFT)) & CAN_D47_Data_byte_4_MASK)
/*! @} */

/* The count of CAN_D47 */
#define CAN_D47_COUNT                            (4U)
