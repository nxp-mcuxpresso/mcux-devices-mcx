...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MCXL142
**
...
/*!
 * @file MCXL142_COMMON.h
 * @version 1.0
 * @date 2023-01-09
 * @brief CMSIS Peripheral Access Layer for MCXL142
 *
 * CMSIS Peripheral Access Layer for MCXL142
 */

#if !defined(MCXL142_COMMON_H_)
#define MCXL142_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#include "system_MCXL142.h"            /* Device specific configuration file */

#define MCXL142_SERIES
/* CPU specific feature definitions */
#include "MCXL142_features.h"
