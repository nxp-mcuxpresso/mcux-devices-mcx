 ...
 * @version 1.0
 * @date 2022-03-08
 * @brief Device specific configuration file for MCXW235B (header file)
 *
...
#ifndef _SYSTEM_MCXW235B_H_
#define _SYSTEM_MCXW235B_H_                      /**< Symbol preventing repeated inclusion */
